...
#ifndef ATB_SPEED_PLUGIN_ACLNN_LEN_OPERATION_H
#define ATB_SPEED_PLUGIN_ACLNN_LEN_OPERATION_H
...
class LenOperation : public AclNNOperation {
public:
    explicit LenOperation(const std::string &name);
    ~LenOperation() override;
...
private:
    aclScalar* start_ = nullptr;
    aclScalar* end_ = nullptr;
    aclScalar* step_ = nullptr;
};
} // namespace common
} // namespace atb_speed

#endif // ATB_SPEED_PLUGIN_ACLNN_Len_OPERATION_H
