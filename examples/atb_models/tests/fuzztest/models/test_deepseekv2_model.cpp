...
namespace atb_speed {
void SetDeepseekv2IntParam(uint32_t &fuzzIndex, nlohmann::json &parameter, nlohmann::json &aclParameter)
{
...
void SetDeepseekv2StringParam(uint32_t &fuzzIndex, nlohmann::json &parameter, nlohmann::json &aclParameter)
{
...
void SetDeepseekv2JsonParam(uint32_t &fuzzIndex, nlohmann::json &parameter, nlohmann::json &aclParameter)
{
...
void SetDeepseekv2VectorParam(uint32_t &fuzzIndex, nlohmann::json &parameter, nlohmann::json &aclParameter)
{
...
void SetDeepseekv2SVectorpackParam(uint32_t &fuzzIndex, nlohmann::json &parameter, nlohmann::json &aclParameter)
{
    int numHiddenLayers = *(int *) DT_SetGetNumberRange(&g_Element[fuzzIndex++], 1, 1, 30);
    parameter["numHiddenLayers"] = numHiddenLayers;
...
void SetDeepseekv2SVectorQuantTypeParam(uint32_t &fuzzIndex, nlohmann::json &parameter, nlohmann::json &aclParameter)
{
    int numHiddenLayers = *(int *) DT_SetGetNumberRange(&g_Element[fuzzIndex++], 1, 1, 30);
    parameter["numHiddenLayers"] = numHiddenLayers;
...
void SetDeepseekv2SVectorTransposeTypeParam(
...
TEST(Deepseekv2ModelDTFuzz, Deepseekv2Model)
{
    std::srand(time(NULL));
    std::string fuzzName = "Deepseekv2ModelDTFuzzDeepseekv2Model";
    ...
    DT_FUZZ_START(0, 10000, const_cast<char*>(fuzzName.c_str()), 0) {
        ...
        SetDeepseekv2IntParam(fuzzIndex, parameter, aclParameter);
        SetDeepseekv2StringParam(fuzzIndex, parameter, aclParameter);
        SetDeepseekv2JsonParam(fuzzIndex, parameter, aclParameter);
        SetDeepseekv2VectorParam(fuzzIndex, parameter, aclParameter);
        SetDeepseekv2SVectorpackParam(fuzzIndex, parameter, aclParameter);
        SetDeepseekv2SVectorQuantTypeParam(fuzzIndex, parameter, aclParameter);
        SetDeepseekv2SVectorTransposeTypeParam(fuzzIndex, parameter, aclParameter);

        std::string parameter_string = parameter.dump();
        std::string acl_parameter_string = aclParameter.dump();

        try {
            pybind11::object deepseekv2Fuzz = modelModule.attr("BaseFuzz");
            pybind11::object deepseekv2FuzzIns = deepseekv2Fuzz("deepseekV2_DecoderModel");
            
            pybind11::object ret = deepseekv2FuzzIns.attr("set_param")(parameter_string);
            if (ret.cast<int>() == 0) {
                deepseekv2FuzzIns.attr("set_weight")();
                deepseekv2FuzzIns.attr("set_kv_cache")();
                deepseekv2FuzzIns.attr("execute")(acl_parameter_string);
            }
