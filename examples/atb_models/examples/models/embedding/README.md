...
|--------------------|----------------------------|-----------------------------|------|------|-----------------|-----------------|--------|---------|------------|------|-------|----------------|-----|-----|
| bge-large-zh-v1.5  | 支持 world size 1             | 支持 world size 1              | ✅    | ❌    | ✅               | ❌               | ❌      | ❌       | ❌          | ❌    | ❌     | ❌              | ❌   | ❌   |
| bge-reranker-large | 支持 world size 1             | 支持 world size 1              | ✅    | ❌    | ✅               | ❌               | ❌      | ❌       | ❌          | ❌    | ❌     | ❌              | ❌   | ❌   |
| bge-m3             | 支持 world size 1             | 支持 world size 1              | ✅    | ❌    | ✅               | ❌               | ❌      | ❌       | ❌          | ❌    | ❌     | ❌              | ❌   | ❌   |
| Conan-embedding-v1 | 支持 world size 1             | 支持 world size 1              | ✅    | ❌    | ✅               | ❌               | ❌      | ❌       | ❌          | ❌    | ❌     | ❌              | ❌   | ❌   |
| puff-large-v1      | 支持 world size 1             | 支持 world size 1              | ✅    | ❌    | ✅               | ❌               | ❌      | ❌       | ❌          | ❌    | ❌     | ❌              | ❌   | ❌   |
...
| script_path  | 脚本所在路径。向量化模型的脚本所在路径为 `${llm_path}/examples/models/embedding`                                                              |
| weight_path  | 模型权重所在路径                                                                                                                      |
| dataset_path | 数据集所在路径                                                                                                                       |

## 推理环境准备

- 参考 [atb_models 的 README 文件](../../../README.md)配置好推理环境
- 设置环境变量
...
点击[开源权重](#开源权重)中的链接，下载🤗HuggingFace 模型官方页面中的所有文件至 `${weight_path}` 目录
...
2. 使用🤗HuggingFace Transformers 并自己编写脚本推理
