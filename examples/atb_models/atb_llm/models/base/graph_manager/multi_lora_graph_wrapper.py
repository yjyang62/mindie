...
class MultiLoraGraphWrapper(ATBGraphWrapper):
    def __init__(self):
        super().__init__()

        self.feature_name = FeatureType.MULTI_LORA
        self.feature_params = {"enableLora": True, "loraEnableGMM": True}
    
    def activate(self, context: FlashForCausalLM, runtime_params, **kwargs) -> bool:
        return context.lora_modifier.use_multi_adapters()