...
if [ "$TP_WORLD_SIZE" == "1" ]; then
    python -m examples.models.glm41v.glm41v $extra_param
else
    torchrun --nproc_per_node $TP_WORLD_SIZE --master_port $MASTER_PORT -m examples.models.glm41v.glm41v $extra_param
fi