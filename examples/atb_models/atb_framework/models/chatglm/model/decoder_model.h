...
#ifndef ATB_SPEED_MODELS_CHATGLM_DECODER_MODEL_H
#define ATB_SPEED_MODELS_CHATGLM_DECODER_MODEL_H
...
class ChatglmModelParam : public atb_speed::base::ModelParam {
};

class ChatglmDecoderModel : public atb_speed::base::DecoderModel {
public:
    explicit ChatglmDecoderModel(const std::string &param);
...
protected:
    ...
    ChatglmModelParam param;
    std::vector<int> blockNumsList_;
};

REGISTER_MODEL(chatglm, ChatglmDecoderModel);
}  // namespace chatglm
}  // namespace atb_speed
#endif
