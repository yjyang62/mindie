...
#设置自己的ranktable_file_path，machine_IP， master_IP, jemalloc
export RANK_TABLE_FILE="ranktable_file_path/hccl_2s_16p.json"
export MIES_CONTAINER_IP='machine_IP'
