...
#ifndef ATB_SPEED_MODELS_BAICHUAN2_7B_PA_QUANT_LAYER_H
#define ATB_SPEED_MODELS_BAICHUAN2_7B_PA_QUANT_LAYER_H
...
public:
    explicit PagedAttentionQuantLayer(const atb_speed::base::LayerParam &param);
};
