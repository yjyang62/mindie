...
namespace atb_speed {
namespace common {
struct AclNNAddNormDynamicQuantMatmulParam {
...
public:
    explicit AddRmsNormDynamicQuantOperation(const std::string &name, AclNNAddNormDynamicQuantMatmulParam param);
...
private:
    ...
    AclNNAddNormDynamicQuantMatmulParam param_;
