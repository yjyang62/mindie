...
from atb_llm.models.qwen2.flash_causal_qwen2_v3 import FlashQwen2ForCausalLMV3
...
class TestFlashQwen2ForCausalLMV3(unittest.TestCase):
    ...
    @patch("atb_llm.models.qwen2.flash_causal_qwen2_v3.Qwen2Model", MagicMock())
    @patch("atb_llm.models.qwen2.flash_causal_qwen2_v3.ColumnParallelLinear", MagicMock())
    def setUp(self):
        ...
        self.model = FlashQwen2ForCausalLMV3(self.mindie_llm_config, self.weight_loader)
    
    @patch("atb_llm.models.base.flash_causal_lm_v3.get_default_net", MagicMock())
    @patch("atb_llm.models.qwen2.flash_causal_qwen2_v3.gather", MagicMock())
    @patch("atb_llm.models.qwen2.flash_causal_qwen2_v3.dist", MagicMock())
