...
class AllGatherLmHeadCommonOpBuilder(BaseLmHeadCommonOpBuilder):
    def __init__(self):
        super().__init__()
    ...
    def is_match(self, param: dict):
        ...
        if parallel_type is not None and parallel_type != ParallelType.ALL_GATHER:
            return False
        parallel_info = self.param.linear_parallel_param.get("parallel_info")
