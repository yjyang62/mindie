...
class SingleLoraGraphWrapper(ATBGraphWrapper):
    def __init__(self):
        super().__init__()

        self.feature_name = FeatureType.SINGLE_LORA
        self.feature_params = {"enableLora": True}
    
    def activate(self, context: FlashForCausalLM, runtime_params, **kwargs) -> bool:
        return context.lora_modifier.use_single_adapter()