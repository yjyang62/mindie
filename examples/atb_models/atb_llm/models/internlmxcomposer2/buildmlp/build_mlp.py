...
# Implement build_vision_tower based on build_vision_tower from internlm/internlm-xcomposer2-vl-7b
# Implement build_vision_projector based on build_vision_projector from internlm/internlm-xcomposer2-vl-7b
# Implement IdentityMap based on IdentityMap from internlm/internlm-xcomposer2-vl-7b
# Implement CLIPVisionTower based on CLIPVisionTower from internlm/internlm-xcomposer2-vl-7b
# Implement PLoRA based on PLoRA from internlm/internlm-xcomposer2-vl-7b
