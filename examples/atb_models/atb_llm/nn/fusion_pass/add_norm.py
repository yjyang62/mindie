...
class AddRmsNormPass(FusionPassBase):
    """
    A fusion pass that fuses an element-wise addition operation followed by an RMS normalization operation
    ...
    def __init__(self):
        ...
        Due to differences in implementation, it fluctuates within a range of 1e-03 compared to the unfused version.
        """
        super().__init__()
        # input
        a = Tensor()
        ...
        # node after fusing
        add_norm_node = Node('AddRmsNorm', {"epsilon": 1e-6}, [a, b, norm_weight], [a_b_norm, rmsout, a_b])
        self.nodes_after_fusing.append(add_norm_node)
