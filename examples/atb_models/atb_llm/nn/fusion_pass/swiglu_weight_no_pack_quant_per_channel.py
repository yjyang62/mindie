...
class SwigluWeightNoPackQuantPerChannelPass(FusionPassBase):
    """
    ...
    def __init__(self):
        ...
        swiglu_quant_node = Node("DequantSwigluQuant", param, [concat_out, quant_scales, quant_offset], [swiglu_quant_out, scale])
    ...
    def _check_param_by_pass(self, target_graph: list[Node]) -> bool:
        ...
        if target_graph[0].op_param['activationType'] == 'ACTIVATION_SWISH' and \
            target_graph[1].op_param['elewiseType'] == 'ELEWISE_MUL' and \
