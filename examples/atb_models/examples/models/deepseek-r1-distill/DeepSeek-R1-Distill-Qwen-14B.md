...
DeepSeek-R1-Distill-Qwen-14B 为 DeepSeek 利用由 DeepSeek-R1 生成的推理数据，对密集型模型 Qwen2.5 进行了微调。评估结果显示，提炼后的小型密集模型在基准测试中的表现非常出色。
...
| ----------------- |----------------------------|-----------------------------| ---- | ---- | --------------- | --------------- | -------- | --------- | ------------ | -------- | ------- | -------------- | --- | ------ | ---------- | --- | --- | --- |
| DeepSeek-R1-Distill-Qwen-14B | 支持 world size 1,2,4,8 | 支持 world size 2,4,8 | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
...
models = [
    dict(
        ...
        path="/path/to/DeepSeek-R1-Distill-Qwen-14B", # 模型权重文件夹路径
