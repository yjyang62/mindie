...
def all_reduce_worker(rank, world_size, world_input):
    ...
    out_tensor_0 = torch.zeros(m, n, dtype=torch.float16).npu()
    ...
    # gloden
    golden_out_tensor = torch.sum(world_input, dim=0)
...
class TestALLReduceOperation(operation_test.OperationTest):
    def setUp(self):
        self.world_size = 2
    ...
    def test_float16(self):
        ...
        mp.spawn(all_reduce_worker, nprocs=self.world_size, args=(self.world_size, world_input))
